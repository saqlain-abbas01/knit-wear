...
export default function Home() {
  return (
    <main className="container mx-auto max-w-7xl flex min-h-screen flex-col w-full ">
      <AnimatedBanner />
      ...
      <section className="px-4 py-12 md:py-24 space-y-8">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <p className="text-muted-foreground md:text-xl max-w-[700px]">
            Discover our premium collection of underwear designed for everyday
        ...
        <div className=" space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-[700px] mx-auto">
              We prioritize quality, comfort, and sustainability in every piece
              we create.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            ...
            <div className="bg-background p-6 rounded-lg text-center space-y-3">
              ...
              <p className="text-muted-foreground">
                Eco-friendly production with responsible sourcing.
              </p>
            </div>
            <div className="bg-background p-6 rounded-lg text-center space-y-3">
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
              ...
              <p className="text-muted-foreground">
                Designed for all body types with inclusive sizing.
              </p>
            </div>
          </div>
        </div>
